...
linear_branch/ + adapters/), dropped under
...
def resolve_vdn_checkpoint(name):
    ...
    raise FileNotFoundError(
        f"VDN checkpoint {name!r} not found under {vdn_folders()}. For this 24GB build, "
        "install the complete stage-dmd-step-250-int8_convrot_comfyui directory under "
        "<ComfyUI>/models/vdn/. For this 24GB release use stage-dmd-step-250-int8_convrot_comfyui; upstream VDN checkpoints originate from OpenVDN/vdn-minimax-h3. Keep the "
